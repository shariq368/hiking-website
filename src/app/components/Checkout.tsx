...
const Checkout = () => {
  return (
    <div id="checkout">
    <div className="flex flex-col md:flex-row items-center p-6 mt-20 rock-image bg-no-repeat bg-center sm:bg-right relative ">
          <div className="md:w-1/2 text-center md:text-left mb-6 md:mb-0">
            ...
            <Link href="#" className="inline-block bg-orange-500 text-white py-2 px-4 rounded-lg mt-4 hover:scale-105 duration-300">GET THE GUIDE</Link>
          </div>
