...
const Form = () => {
  return (
    ...
    <div className="flex items-center justify-center mt-20 ">
          <div className=" p-10 rounded-lg shadow-lg border-2 border-red-300 max-w-2xl w-full">
            <form className="space-y-4">
              <input type="text" placeholder="Your Name" className="w-full p-3 rounded-full border border-slate-300  focus:outline-none focus:ring-2 focus:ring-red-300 dark:focus:ring-red-500"/>
              <input type="email" placeholder="Your Email" className="w-full p-3 rounded-full border border-slate-300  focus:outline-none focus:ring-2 focus:ring-red-300 dark:focus:ring-red-500"/>
