...
<div className="navbar bg-transparent z-50">
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
        ...
        <li><Link href={'/'} >GO HIKING</Link ></li>
  ...
  <div className="relative">
                <input type="text" className="bg-[#6bd5f0] dark:bg-white text-white dark:text-zinc-200 rounded-full px-4 py-1 focus:outline-none" placeholder="Search"/>
