...
const Adventuresec = () => {
  return (
    ...
    <div className="text-center mb-8">
      ...
      <p className="text-zinc-600">LOREM IPSUM DOLOR SIT AMET ADIPISCING ELIT. VENIAM FACILIS.</p>
    </div>
    <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-8">
      <div className="text-center">
        ...
        <p className="text-zinc-600 mt-5 px-16">Lorem ipsum dolor sit amet consectetur adipiscing elit. Dolorem harum aspernatur sapiente error voluptas fuga laudantium ullam magni fugit. Qui!</p>
      </div>
      <div className="text-center">
